...
@Component({
  ...
  styles: [`
    ...
    .ghost, .filter-row button, .filter-row select { background: rgba(255, 255, 255, 0.7); color: var(--ink); border: 1px solid var(--line); }
    ...
    .user-card { background: #fffefb; border: 1px solid rgba(215, 209, 194, 0.7); border-radius: 22px; padding: 18px; }
